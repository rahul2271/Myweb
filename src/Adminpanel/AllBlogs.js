...
const AllBlogs = () => {
  ...
  return (
    <div className="container mx-auto mt-5 h-[800px] overflow-hidden">
      ...
      <table className="min-w-full bg-gray-700 border-collapse border border-gray-300 w-full">
        <thead>
          <tr>
      ...
      {showModal && (
         <div
         className="items-center justify-center z-50 bg-opacity-50 bg-gray-900 rounded-lg overflow-hidden "
         style={{
           position: 'fixed',
           top: '50%',
           left: '50%',
       ...
       >
          <div className="p-8 rounded-lg w-1/2">
            ...
            <input
              ...
              placeholder="Author"
              className="border border-gray-300 px-4 py-2 rounded-md w-full mb-4 bg-gray-700"
            />
            <ReactQuill
            ...
            <div className="mb-4">
              ...
              <input type="file" onChange={handleImageChange} className="border border-gray-300 px-4 py-2 rounded-md w-full" />
            </div>

            <button onClick={handleSave} className="bg-blue-600 text-white px-4 py-2 rounded-md ">
              Save
            </button>
            <button onClick={handleModalClose} className=" text-white px-4 py-2 rounded-md ml-2 ">
              Cancel
            </button>
          </div>
        </div>
