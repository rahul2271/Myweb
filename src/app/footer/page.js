...
export default function Footer(){
    ...
    <footer className="mx-auto place-content-center relative overflow-hidden py-8">
      ...
      <Image width={100} height={100}  className='hidden md:block mx-auto md:ml-[12px] md:mt-[25px]  relative' src="/3dlogo.png" alt="RC Tech Solutions" />
      ...
      <div className="md:mt-[-115px] md:mr-[-1110px] w-auto p-8">
        <div className="place-content-center flex flex-wrap">
          ...
          <div className="w-auto p-1.5">
            <Link href="https://www.instagram.com/rc_tech_solutions_/">
              <div className="flex h-[50px] bg-mypurple w-[50px] md:w-[50px] md:h-[50px] items-center justify-center rounded-full  border-gray-100 hover:border-white">
                <svg
                  width="20"
                  height="30"
          ...
          <div className="w-auto p-1.5">
            <Link href="https://in.pinterest.com/rc_tech_solutions/">
              <div className="flex h-[50px] bg-mypurple w-[50px] md:w-[50px] md:h-[50px] items-center justify-center rounded-full  border-gray-100 hover:border-white">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-pinterest" viewBox="0 0 16 16">
          ...
          <div className="w-auto p-1.5">
            <Link href="https://www.linkedin.com/company/rc-tech-solution/">
              <div className="flex h-[50px] bg-mypurple w-[50px] md:w-[50px] md:h-[50px] items-center justify-center rounded-full  border-gray-100 hover:border-white">
