...
export default function RootLayout({
  ...
  return(
    ...
    <img className='md:hidden mt-[20px] mx-auto w-auto place-content-center block  ml-[140px] h-[70px] w-[70px]' src="logo.png" alt="LOGO"/>
    ...
    <div className="hidden lg:block">
      <ul className="inline-flex space-x-8">
        <li>
          <a
            href="#"
            className="hover:text-white text-sm font-semibold text-gray-800 hover:text-gray-900"
          >
            Home
          </a>
        </li>
    ...
    <footer className="mx-auto place-content-center relative overflow-hidden py-8">
      ...
      <img className='hidden md:block mx-auto md:ml-[12px] md:mt-[25px]  relative h-[100px] w-[100px] ' src="./logo.png" alt="rchauhan.in" />
        ...
        <ul className="text-center relative md:absolute place-content-center md:m-5 md:flex flex-column md:flex-wrap">
          <li className="p-5">
            <Link className="text-center font-medium md:text-[20px] text-gray-300 hover:text-mypurple" href="#">
              Privacy Policy
            </Link>
          </li>
          <li className="p-5">
      ...
      <div className="md:mt-[-115px] md:mr-[-1110px] w-auto p-8">
        <div className="place-content-center flex flex-wrap">
          ...
          <div className="w-auto p-1.5">
            <Link href="https://twitter.com/RchauhanI66121">
              <div className="flex h-[50px] bg-mypurple w-[50px] md:w-[50px] md:h-[50px] items-center justify-center rounded-full  border-gray-100 hover:border-white">
                <svg
                  width="20"
                  height="30"
