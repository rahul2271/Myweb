    ...
    <html lang="en">
      <body className={poppins.className}>
        ...
        {/* <img className=' absolute m-[20px]' src="./hamburger.png" alt="dddd" /> */}
          <img className=' mx-auto  relative  h-[150px] w-[150px] md:h-[50px] md:w-[50px] md:mt-[50px] md:mx-[10px]' src="./logo.png" alt="rchauhan" />
          ...
          <Link href="/contact" className="hidden md:block lg:block mx-auto md:mt-[-30px] md:ml-[700px] flex place-content-center mt-[20px]">
            <button
              type="button"
              className="rounded-md bg-[#953ee2] px-3 py-2 md:px-2 md:py-1 md:text-[10px]  text-sm font-bold text-grey-300 shadow-sm hover:bg-mypurple/80 ">
              Contact Us
            </button>
          </Link>
        </header>
    ...
    <footer className="mx-auto place-content-center relative overflow-hidden py-8">
      ...
      <img className='hidden md:block mx-auto md:ml-[12px] md:mt-[25px]  relative h-[50px] w-[50px] ' src="./logo.png" alt="rchauhan.in" />
        ...
        <ul className="text-center relative md:absolute place-content-center md:m-5 md:flex flex-column md:flex-wrap">
          <li className="p-5">
            <Link className="text-center font-medium md:text-[10px] text-gray-300 hover:text-mypurple" href="#">
              Privacy Policy
            </Link>
          </li>
          <li className="p-5">
            <Link className="font-medium text-gray-300 md:text-[10px] hover:text-mypurple" href="#">
              Terms of Service
            </Link>
          </li>
          <li className="p-5">
          ...
          <li className="p-5">
            <Link className="font-medium text-gray-300 md:text-[10px] hover:text-mypurple" href="/contact">
              Contact Us
            </Link>
          </li>
        </ul>
      </div>
      <div className="md:mt-[-75px] md:mr-[-610px] w-auto p-8">
        <div className="place-content-center flex flex-wrap">
          <div className="w-auto p-1.5">
            <a href="#">
              <div className="flex h-[50px] bg-mypurple w-[50px] md:w-[30px] md:h-[30px] items-center justify-center rounded-full  border-gray-100 hover:border-white">
                <svg
                  width="10"
                  height="30"
                  viewBox="0 0 8 14"
