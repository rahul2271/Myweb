      ...
      <div className="flex flex-wrap -mx-2 px-5">
        {blogs.map((blog) => (
          <div key={blog.id} className="w-full sm:w-1/2 md:w-1/4 px-2 mb-4 overflow-hidden">
            <div className="bg-black p-4 shadow-mypurple shadow-md/50 rounded-lg h-[400px] overflow-hidden">
              <Link href={`/blogs/${blog.slug}`} legacyBehavior>
                <a>
                  ...
                  <div className="p-4">
                    <h2 className="px-2 bg-white rounded dark:bg-white text-xl font-bold mb-4 text-mypurple">{blog.title}</h2> 
