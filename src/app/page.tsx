...
<Head>
    ...
    <div className="mx-auto max-w-xl text-center">
      ...
      From design to deployment, we have got your <Link href='./about'>web presence</Link> covered—your all-in-one solution for digital excellence.
      </p>
    </div>
    <div className="mt-12 grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
      <div className='hover:border-white  hover:bg-mypurple/20  border-2 p-[20px] border-mypurple rounded-2xl'>
        ...
        Elevate your online presence with our expert <Link href='./services'>web development services</Link>—where innovation meets impeccable design.
        </p>
      </div>
      <div className='hover:border-white  hover:bg-mypurple/20 border-2 p-[20px] border-mypurple rounded-2xl'>
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full ">
        ...
        <p className="mt-8 text-sm text-gray-200">
        Ignite your brand with our <Link href='./services'>graphic design services</Link> magic—where creativity meets visual brilliance.
        </p>
      </div>
      <div className='hover:border-white  hover:bg-mypurple/20 border-2 p-[20px] border-mypurple rounded-2xl'>
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full ">
        ...
        <p className="mt-8 text-sm text-gray-200">
        Unleash the power of words with our <Link href='./services'>content writing services</Link>—where every sentence tells your story and captivates your audience.
        </p>
      </div>
      <div className='hover:border-white  hover:bg-mypurple/20 border-2 p-[20px] border-mypurple rounded-2xl'>
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full ">
        ...
        <p className="mt-8 text-sm text-gray-200">
        Elevate your brand with our expert <Link href='./services'>digital marketing services</Link> – where visibility meets success in the online landscape.
        </p>
      </div>
      <div className='hover:border-white  hover:bg-mypurple/20 border-2 p-[20px] border-mypurple rounded-2xl'>
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full ">
        ...
        <p className="mt-8 text-sm text-gray-200">
        Transforming moments into cinematic magic—our <Link href='./services'>video editing services</Link> make your story unforgettable.
        </p>
      </div>
      <div className='hover:border-white  hover:bg-mypurple/20 border-2 p-[20px] border-mypurple rounded-2xl'>
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full ">
        ...
        <p className="mt-8 text-sm text-gray-200">
        Boost your online presence with our expert <Link href='./services'>SEO services</Link>—because being found is the first step to being remembered.
        </p>
      </div>
      <div className='hover:border-white  hover:bg-mypurple/20 border-2 p-[20px] border-mypurple rounded-2xl'>
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full ">
        ...
        <p className="mt-8 text-sm text-gray-200">
        Elevate your brand online charisma with our <Link href='./services'>Social Media Marketing Services</Link>– where engagement meets strategy, and your story takes center stage.
        </p>
      </div>
      <div className='hover:border-white  hover:bg-mypurple/20 border-2 p-[20px] border-mypurple rounded-2xl'>
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full ">
        ...
        <p className=" mt-8 text-sm text-gray-200">
        Elevate your online presence with our <Link href='./services'>Social Media Optimization Services</Link>— where visibility meets engagement, and your brand becomes the talk of the digital town!
        </p>
      </div>
    </div>
  </div>    
      ...
      <figure className="mx-auto">
        ...
        <blockquote className="md:text-[20px] tracking-wide leading-6 mt-10 text-xs text-left text-grey-300">
          <p className='max-w-4xl m-auto place-content-center'>
            “Choosing this web service was a game-changer for my business. Their innovative designs and seamless functionality not only elevated my <Link href='./contact'>online presence</Link> but also significantly boosted my customer engagement. The team expertise and commitment to excellence made the entire process a breeze. I am thrilled with the results and can confidently say they exceeded my expectations. Highly recommended!”
          </p>
        </blockquote>
